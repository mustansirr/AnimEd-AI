...
from app.agents.prompts.planner_prompts import (  # noqa: E402
    PLANNER_SYSTEM_PROMPT,
    create_planner_prompt,
)
from app.agents.prompts.scripter_prompts import (  # noqa: E402
...
def check_config():
    ...
    is_key_set = settings.groq_api_key and settings.groq_api_key != 'your_groq_api_key'
    print(f"Groq API Key: {'✅ Set' if is_key_set else '❌ Not set'}")
