...
export default function HowItWorks() {
  ...
  return (
    ...
    >
      {/* Background accent */}
      <div className="absolute top-0 right-0 w-[500px] h-[500px] rounded-full bg-indigo-100/30 blur-[150px]" />
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="relative">
          ...
          <div className="hidden lg:block absolute top-24 left-[16.66%] right-[16.66%] h-px bg-gradient-to-r from-violet-300/40 via-indigo-400/60 to-blue-300/40" />
            ...
            {steps.map((step, index) => (
              ...
              >
                ...
                <div className="relative mb-8">
                  <div
                    className={`flex h-20 w-20 items-center justify-center rounded-2xl bg-gradient-to-br ${step.gradient} shadow-lg shadow-violet-500/15`}
                  >
